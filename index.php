...
<html lang="en">
  ...
  <body>
    ...
    <main class="hero-section">
      <img src="assets/unmul-gedung.jpeg" alt="Universitas Mulawarman" class="hero-image" />
      ...
      <div class="hero-container">
        ...
        <search>
          <form action="" class="search-bar-mahasiswa">
            <input type="text" placeholder="Ketik nama atau NIM di sini" class="search-input-mahasiswa" />
